#
#  Be sure to run `pod spec lint ColorPalette.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ColorPalette"
  s.version      = "0.0.1"
  s.summary      = "A color palette grid view for iOS."
...
![alt tag](https://github.com/cemolcay/ColorPalette/raw/master/storyboard.png)
  ...
  s.homepage     = "https://github.com/cemolcay/ColorPalette"
  ...
  s.source       = { :git => "https://github.com/cemolcay/ColorPalette.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ColorPalette/ColorPaletteView.swift"
